        ...
        (() => {
          ...
          if (columns === 1) {
            ...
            list.forEach(elem => {
              ...
              // 最大高度不能超过宽度的2倍
              let itemHeight = Math.min(itemWidth * (elem.height / elem.width), itemWidth * 2);
              itemHeight = Math.max(itemHeight, minHeight);
                ...
                {items.map(d => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        width: itemWidth,
                        height: props.itemHeight ? 'auto' : Math.max(hei, 60),
                        marginBottom: gap,
                      }}
                    >
