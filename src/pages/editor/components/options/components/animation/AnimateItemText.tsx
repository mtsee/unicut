  ...
  return (
    <div className={styles.itemText}>
      ...
      <span className={styles.abc}>
        <i style={{ animationName: `H5_text_${item.id}`, animationDelay: '0s' }}>A</i>
        <i style={{ animationName: `H5_text_${item.id}`, animationDelay: '0.1' }}>B</i>
        <i style={{ animationName: `H5_text_${item.id}`, animationDelay: '0.2s' }}>C</i>
      </span>
    </div>
  );
}
